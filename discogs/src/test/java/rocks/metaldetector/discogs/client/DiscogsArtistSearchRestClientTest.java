...
import rocks.metaldetector.discogs.client.DtoFactory.DiscogsArtistFactory;
import rocks.metaldetector.discogs.client.DtoFactory.DiscogsArtistSearchResultFactory;
...
class DiscogsArtistSearchRestClientTest implements WithAssertions {
  ...
  class SearchByNameTest {
    ...
    void search_by_name() {
      ...
      // when
      Optional<DiscogsArtistSearchResultDto> result = artistSearchClient.searchByName(ARTIST_NAME_QUERY, DEFAULT_PAGE, DEFAULT_SIZE);
...
//      verify(restTemplate, times(1)).getForEntity(SEARCH_BY_NAME_URL, DiscogsArtistSearchResultContainer.class, ARTIST_NAME_QUERY, DEFAULT_PAGE, DEFAULT_SIZE);
    ...
    void search_by_name_with_invalid_artist_name(String artistName) {
      // when
      Optional<DiscogsArtistSearchResultDto> result = artistSearchClient.searchByName(artistName, DEFAULT_PAGE, DEFAULT_SIZE);
