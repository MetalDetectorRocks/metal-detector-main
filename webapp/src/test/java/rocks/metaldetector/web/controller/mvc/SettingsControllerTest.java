...
class SettingsControllerTest {
  ...
  @BeforeEach
  void setup() {
    restAssuredUtils = new RestAssuredMockMvcUtils(Endpoints.Frontend.SETTINGS);
    callbackRestAssuredUtils = new RestAssuredMockMvcUtils(Endpoints.Frontend.SETTINGS + Endpoints.Frontend.SPOTIFY_CALLBACK);
  ...
  @Test
  @DisplayName("Requesting '" + Endpoints.Frontend.SETTINGS + "' should be ok")
  ...
  @Test
  @DisplayName("Requesting '" + Endpoints.Frontend.SETTINGS + "' should return the profile view")
  ...
  @Test
  @DisplayName("Requesting '" + Endpoints.Frontend.SETTINGS + Endpoints.Frontend.SPOTIFY_CALLBACK + "' should be ok")
  ...
  @Test
  @DisplayName("Requesting '" + Endpoints.Frontend.SETTINGS + Endpoints.Frontend.SPOTIFY_CALLBACK + "' should return the profile view")
