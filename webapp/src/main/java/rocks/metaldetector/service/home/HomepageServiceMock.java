...
public class HomepageServiceMock implements HomepageService {
  ...
  private List<ReleaseDto> createUpcomingReleases(LocalDate now) {
    ReleaseDto fromTheAbyss = ReleaseDto.builder().albumTitle("From The Abyss").artist("Drowning The Light").releaseDate(now.plusDays(6)).coverUrl("/images/dummy/drowning-the-light_from-the-abyss.jpg").build();
    ...
    return List.of(fromTheAbyss, waldvolk, transilvanianHunger, traktat);
  }
