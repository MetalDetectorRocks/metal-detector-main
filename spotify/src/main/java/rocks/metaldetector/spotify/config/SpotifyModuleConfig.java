...
public class SpotifyModuleConfig {
  ...
  private final ResponseErrorHandler customClientErrorHandler;

  @Bean
  public RestOperations spotifyOAuthClientCredentialsRestTemplate(OAuth2AccessTokenClient accessTokenClient) {
  ...
  @Bean
  public RestOperations spotifyOAuthAuthorizationCodeRestTemplate(OAuth2AccessTokenClient accessTokenClient) {
