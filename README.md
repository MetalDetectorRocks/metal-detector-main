...
6. Deposit your Spotify Client ID and Client Secret in file `application.yml`:
    - `spotify.client-id`
    - `spotify.client-secret`

7. Define JWT Issuer and secrets (you can choose any value you want) in file `application.yml`:
