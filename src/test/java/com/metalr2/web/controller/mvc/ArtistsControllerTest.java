...
class ArtistsControllerTest implements WithIntegrationTestProfile {
  ...
  void get_artist_details_should_return_search_artists_view() throws Exception {
    mockMvc.perform(get(Endpoints.Frontend.ARTISTS + "/123456"))
        ...
        .andExpect(content().contentType("text/html;charset=UTF-8"))
        .andExpect(content().string(containsString("Artist name")));
  }
}